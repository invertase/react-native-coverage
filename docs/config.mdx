...
Copy [`react-native-coverage.config.js.example`](https://github.com/invertase/react-native-coverage/blob/main/react-native-coverage.config.js.example) to `react-native-coverage.config.js` in your dedicated test app.
